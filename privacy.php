...
<html>
	<head>
	<!-- /.website title -->
    <title>Privacy Policy, NIT Jalandhar</title>
...
<div class="fullscreen landing parallax" style="background-image:url(images/logo101.jpg.jpg);" data-img-width="2000" data-img-height="1325" data-diff="100">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					...
					<!-- /.logo -->
					<div class="logo wow fadeInDown"> <a href="index.php"><img src="images/logo.gif" alt="logo"></a></div>
						<!-- /.main title -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="text-center"><a href="index.php">Back to Main Page</a></div>
			</div>	
...
<footer id="footer">
	<div class="container">
		<div class="col-sm-4 col-sm-offset-4">
						<div class="text-center wow fadeInUp">&copy; NITJ</div>
		</div>	
	</div>	
</footer>
